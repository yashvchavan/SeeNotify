...
const SettingsScreen = () => {
  ...
  const renderSettingItem = (icon:any, title:any, description:any, value:any, onToggle:any, iconColor = isDark ? "#6366f1" : "#4f46e5") => {
    const Icon = icon
  ...
  const renderLinkItem = (icon:any, title:any, onPress:any, iconColor = isDark ? "#6366f1" : "#4f46e5") => {
    const Icon = icon
        ...
        <Animated.View style={contentStyle}>
          ...
          <View style={styles.section}>
            ...
            >
              ...
              {renderLinkItem(LogOut, "Log Out", handleLogout, "#ef4444")}
            </View>
          </View>
